...
static const struct settings_str_entry settings_map[] =
{
		...
		{FreeRDP_CertificateUseKnownHosts, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_CertificateUseKnownHosts"},
		...
		{FreeRDP_RelativeMouseInput, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_RelativeMouseInput"},
		...
		{FreeRDP_VirtualChannelCompressionFlags, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_VirtualChannelCompressionFlags"},
	...
	for(x=0; x<ARRAYSIZE(settings_map); x++)
	{
		...
		switch(cur->type)
		{
			case 0: /* bool */
			{
				...
				{
					rc=TRUE;
					WLog_Print(log, level, "%s [BOOL]: %s -> %s", cur->str, sval ? "TRUE" : "FALSE", cval ? "TRUE" : "FALSE");
				}
			}
			break;
			case 1: /* UINT16 */
			{
				...
				{
					rc=TRUE;
				WLog_Print(log, level, "%s [UINT16]: %" PRIu16 " -> %" PRIu16, cur->str, sval, cval);
				}
			}
			break;
			case 2: /* INT16 */
			{
				...
				{
					rc=TRUE;
				WLog_Print(log, level, "%s [INT16]: %" PRId16 " -> %" PRId16, cur->str, sval, cval);
				}
			}
			break;
			case 3: /* UINT32 */
			{
				...
				{
					rc=TRUE;
				WLog_Print(log, level, "%s [UINT32]: %" PRIu32 " -> %" PRIu32, cur->str, sval, cval);
				}
			}
			break;
			case 4: /* INT32 */
			{
				...
				{
					rc=TRUE;
				WLog_Print(log, level, "%s [INT32]: %" PRId32 " -> %" PRId32, cur->str, sval, cval);
				}
			}
			break;
			case 5: /* UINT64 */
			{
				...
				{
					rc=TRUE;
				WLog_Print(log, level, "%s [UINT64]: %" PRIu64 " -> %" PRIu64, cur->str, sval, cval);
				}
			}
			break;
			case 6: /* INT64 */
			{
				...
				{
					rc=TRUE;
				WLog_Print(log, level, "%s [INT64]: %" PRId64 " -> %" PRId64, cur->str, sval, cval);
				}
			}
			break;
			case 7: /* strings */
